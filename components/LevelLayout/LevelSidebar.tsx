        ...
        <div className="w-[400px] p-6 flex flex-col justify-between h-full">
            ...
            <div className="space-y-4">
                ...
                <div className='flex items-center gap-2 w-full justify-between'>
                    <AnimatedButton onClick={() => router.push('/connections')} className='px-8 py-4 w-full text-3xl font-outfit font-semibold bg-white text-[#691B12] rounded-full shadow-lg cursor-pointer hover:scale-102'>Menu</AnimatedButton>
                    <div className='relative'>
